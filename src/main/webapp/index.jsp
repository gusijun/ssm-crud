    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="emp_update_button">update changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="empAndModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="emp_save_button">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function getDepts(ele) {
        ...
        $.ajax({
           ...
           type:  "GET",
           success: function (result) {
               // {"code":100,"msg":"处理成功!","extend":{"depts":[{"deptId":1,"deptName":"开发部"},{"deptId":4,"deptName":"测试部"}]}}
               // console.log(result);
               // 显示部门信息在下拉列表中
               // $("#empAndModal select").append("")
